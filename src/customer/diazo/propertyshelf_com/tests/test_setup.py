# -*- coding: utf-8 -*-
"""Test Setup of customer.diazo.propertyshelf_com."""
...
# local imports
from customer.diazo.propertyshelf_com import (
    config,
    testing,
)
...
CSS = [
    '++resource++customer.diazo.propertyshelf_com/main.css',
]

JS = [
    '++resource++customer.diazo.propertyshelf_com/main.js',
]


class TestSetup(unittest.TestCase):
    """Validate setup process for customer.diazo.propertyshelf_com."""

    layer = testing.CUSTOMER_DIAZO_PROPERTYSHELF_COM_INTEGRATION_TESTING
    ...
    def test_addon_layer(self):
        ...
        self.assertIn('ICustomerDiazoPropertyshelfComLayer', layers)
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        ...
        layers = [l.getName() for l in registered_layers()]
        self.assertNotIn('ICustomerDiazoPropertyshelfComLayer', layers)
